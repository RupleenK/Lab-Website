...
<figure style="float: right; margin-left: 10px; margin-right: 10px; max-width: 60%;">
  <img src="/genesig.jpg" alt="Gene Signature" style="width: 90%; height: auto;">
...
<figure style="float: left; margin-left: 20px; max-width:50%;">
  <img src="/drugresponse.jpg" alt="Drug Response" style="width: 100%; height: auto;">
...
<figure style="float: right; margin-left: 50px; max-width: 60%;">
  <img src="/pten.jpeg" alt="Clinical Research" style="width: 100%; height: auto;">
